...
* [ansi-fsm-specification.md](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/ketraterm-parser/docs/ansi-fsm-specification.md) - Finite-state machine transition matrices, 64-bit CSI signature packing, and dispatch table binary searches.
* [grapheme-segmentation.md](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/ketraterm-parser/docs/grapheme-segmentation.md) - Streaming UTF-8 decoding, character shift states, and Unicode UAX #29 grapheme boundaries.
...
To handle the semantic commands generated by the parser (such as writing text, moving the cursor, or resetting the screen), implement the [TerminalCommandSink](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/ketraterm-parser/src/main/kotlin/io/github/ketraterm/parser/spi/TerminalCommandSink.kt) interface:
