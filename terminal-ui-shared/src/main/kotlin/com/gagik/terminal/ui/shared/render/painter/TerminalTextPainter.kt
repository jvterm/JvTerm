...
import com.gagik.terminal.ui.shared.render.*
import com.gagik.terminal.ui.shared.render.cache.*
import com.gagik.terminal.ui.shared.render.font.TerminalTextRunBuffer
import com.gagik.terminal.ui.shared.render.primitives.TerminalCellPrimitivePainter
import com.gagik.terminal.ui.shared.render.primitives.TerminalPlatformEmojiPainter
...
internal class TerminalTextPainter(
     ...
     */
    fun updateSettings(settings: TerminalRenderSettings) {
    ...
    private fun effectiveForeground(
        ...
        if (hovered && hyperlinkActivationHover) {
            ...
            driver.resolveColor(attr, isBackground = false).rgb
        }
