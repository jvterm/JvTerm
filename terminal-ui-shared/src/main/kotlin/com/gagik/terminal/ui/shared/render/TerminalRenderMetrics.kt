...
/**
 * Frozen terminal cell metrics derived from one host settings snapshot.
 *
 ...
 */
data class TerminalRenderMetrics(
    val cellWidth: Int,
    val cellHeight: Int,
    val baseline: Int,
    val underlineY: Int,
    ...
    companion object {
        /**
         * Builds frozen terminal metrics from AWT font metrics.
         *
         * @param fontMetrics metrics for the configured terminal font.
         * @return stable metrics for terminal grid painting.
         */
        @JvmStatic
        fun from(fontMetrics: FontMetrics): TerminalRenderMetrics {
