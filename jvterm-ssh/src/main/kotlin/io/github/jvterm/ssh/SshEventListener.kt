...
/**
 * Host callbacks for a running SSH-backed terminal session.
 *
 * Implementations should return quickly. Metadata callbacks are delivered from
 * the SSH connector reader path as parser output is handled.
 */
@Suppress("UNUSED_PARAMETER")
interface SshEventListener {
    /**
     * Called when BEL is received from the remote shell.
     *
    ...
    /**
     * Called when the remote shell requests a window resize.
     *
     * @param session session that received the event.
    ...
    /**
     * Called when the remote shell requests moving the window.
     *
     * @param session session that received the event.
    ...
    /**
     * Called when the remote shell requests minimizing the window.
     *
     * @param session session that received the event.
     */
    ...
    /**
     * Called when the remote shell requests deminimizing the window.
     *
     * @param session session that received the event.
     */
    ...
    /**
     * Called when the remote shell requests raising the window.
     *
     * @param session session that received the event.
     */
    ...
    /**
     * Called when the remote shell requests lowering the window.
     *
     * @param session session that received the event.
     */
    ...
    /**
     * Called when the remote shell requests maximizing or restoring the window.
     *
     * @param session session that received the event.
    ...
    /**
     * Called when the remote shell requests a desktop notification.
     *
     * @param session session that received the event.
    ...
    companion object {
        /**
         * Listener used when the host does not need SSH callbacks.
         */
        @JvmField
        val NONE: SshEventListener =
