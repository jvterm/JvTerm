...
* [terminal-core-contract.md](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/ketraterm-core/docs/terminal-core-contract.md) - Headless write behaviors, erasure mechanics, tab stops, cursor save/restore, and buffer lifecycles.
* [grid-storage-layout.md](file:///c:/Users/gagik/IdeaProjects/terminal-buffer/ketraterm-core/docs/grid-storage-layout.md) - Parallel primitive arrays inside `Line`, `HistoryRing` line recycling, and the `ClusterStore` arena allocator.
